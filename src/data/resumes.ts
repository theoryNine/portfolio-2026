...
export const resumes: ResumeOption[] = [
  {
    ...
    description: 'Technical depth, system design, and hands-on delivery',
    href: 'https://www.dropbox.com/scl/fi/0ahz2g8uypyqgybrlbmkf/Ansel-Colvin-Resume-Engineer.pdf?rlkey=ch0u2v2nhwi9gwygav9pibu3x&dl=0',
  },
  {
    label: 'Engineering Manager',
    description: 'Team leadership, hiring, and cross-functional alignment',
